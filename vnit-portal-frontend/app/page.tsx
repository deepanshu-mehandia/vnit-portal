...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ───── RIGHT PANEL ───── */}
      <div className="w-full lg:w-[42%] flex items-center justify-center bg-slate-50 px-6 py-12 overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none px-3 py-2.5 pr-8 rounded-xl border border-slate-200 bg-slate-50 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none px-3 py-2.5 pr-8 rounded-xl border border-slate-200 bg-slate-50 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                      >
