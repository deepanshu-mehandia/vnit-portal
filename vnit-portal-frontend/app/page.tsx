...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      />
      {/* Background overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-950/80 via-blue-900/70 to-indigo-950/75" />
      ...
      {/* ───── LEFT CONTENT (Logo, Headline, Stats) ───── */}
      <div className="relative z-10 hidden lg:flex lg:w-[55%] flex-col justify-between p-14 text-white">
        {/* Logo */}
        <motion.div
      ...
      <div className="relative z-10 w-full lg:w-[45%] flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-center text-white/70 text-xs mt-6 relative z-20">
