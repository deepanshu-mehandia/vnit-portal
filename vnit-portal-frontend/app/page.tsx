...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      {/* ───── RIGHT PANEL (Form) ───── */}
      <div className="w-full lg:w-[42%] relative z-10 flex flex-col items-center justify-center px-6 py-12">
        ...
        >
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/40">
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-semibold text-slate-600 block mb-1.5">Username / Email</label>
                <input type="text" placeholder="your@email.com" value={username}
              ...
              <motion.button whileTap={{ scale:0.98 }} onClick={handleLogin} disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:opacity-60 text-white font-bold py-3.5 rounded-xl transition-all mt-2 shadow-lg shadow-blue-500/25"
              >
                {loading ? (
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              ...
              <motion.button whileTap={{ scale:0.98 }} onClick={() => router.push("/admission")}
